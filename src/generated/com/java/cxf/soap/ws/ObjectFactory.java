 ...
 * generated in the com.java.cxf.soap.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _DownloadFileResponse_QNAME = new QName("http://ws.soap.cxf.java.com/", "downloadFileResponse");
    private final static QName _DownloadFile_QNAME = new QName("http://ws.soap.cxf.java.com/", "downloadFile");
    private final static QName _UploadFile_QNAME = new QName("http://ws.soap.cxf.java.com/", "uploadFile");
    private final static QName _UploadFileResponse_QNAME = new QName("http://ws.soap.cxf.java.com/", "uploadFileResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.java.cxf.soap.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.soap.cxf.java.com/", name = "downloadFileResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.soap.cxf.java.com/", name = "downloadFile")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.soap.cxf.java.com/", name = "uploadFile")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.soap.cxf.java.com/", name = "uploadFileResponse")
